                    ...
                    app.use("/{*path}", function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    _a.trys.push([1, 4, , 5]);
                                    clientTemplate = node_path_1.default.resolve(import.meta.dirname, "..", "client", "index.html");
                                    return [4 /*yield*/, node_fs_1.default.promises.readFile(clientTemplate, "utf-8")];
                                case 2:
                                    template = _a.sent();
